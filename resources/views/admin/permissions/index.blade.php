                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{ URL::to('admin/permissions/create') }}">Add Permission</a></li>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    @foreach ($permissions as $permission)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/permission/{{ $permission->id }}">View</a></td>
                                            <td><a href="{{ URL::to('admin/permissions/' . $permission->id . '/edit') }}">Edit</a></td>
                                            <td>
